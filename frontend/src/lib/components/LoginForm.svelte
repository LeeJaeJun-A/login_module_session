...
<div
  ...
  >
    <div class="min-h-80 w-1/3 h-1/2 bg-white rounded-lg shadow">
      <div class="flex flex-col justify-center items-center p-8 h-full w-full 4xl:p-12">
        <div class="flex justify-center items-center flex-row w-full h-1/6">
          <img class="w-8 h-8 mr-2 4xl:w-12 4xl:h-12 4xl:mr-3" src="/favicon.png" alt="logo" />
          <h1
        ...
        >
          <div>
            <label for="id" class="block mb-2 text-sm font-medium text-gray-900 4xl:text-2xl 4xl:mb-4"
              >ID</label
            >
            <input
              type="text"
